		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SalesOrderV1",
									"targetURL": "#SalesOrderV1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SalesOrderV1-display": {
								"semanticObject": "SalesOrderV1",
								"action": "display",
								"description": "SalesOrderV1",
								"title": "SalesOrderV1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mdpert.sales.SalesOrderV1Module",
									"url": sap.ui.require.toUrl("com/mdpert/sales/SalesOrderV1Module")
								}
							}
						}
					}
